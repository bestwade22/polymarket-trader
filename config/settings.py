...
TIMEZONE_SKIP_DENYLIST_FILE = ANALYSIS_DIR / "timezone_skip_denylist.json"
...
class Settings:
    ...
    # Shipped live stack: skip_bottom7_tz + spread<0.08 + buy>=0.45.
    ...
    sell_win_tier1_price: float = float(os.getenv("SELL_WIN_TIER1_PRICE", "0.94"))
    ...
    sell_win_tier2_price: float = float(os.getenv("SELL_WIN_TIER2_PRICE", "0.96"))
    ...
    sell_win_tier3_price: float = float(os.getenv("SELL_WIN_TIER3_PRICE", "0.98"))
